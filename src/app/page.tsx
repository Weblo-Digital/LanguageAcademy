            ...
            <div className="relative rounded-3xl border border-slate-100 overflow-hidden min-h-[320px] transition-all duration-300 hover:shadow-md group flex flex-col justify-between p-8 bg-white">
              ...
              <div className="absolute inset-0 z-0">
                <Image 
                  ...
                  className="object-cover opacity-20 grayscale transition-transform duration-500 group-hover:scale-105"
                />
                {/* Overlay: from bottom-right 100% (solid white) to top-left 0% (transparent) */}
                <div className="absolute inset-0 bg-gradient-to-tl from-white via-white/90 to-transparent z-10" />
              </div>
